...
class ProductLectureSheets extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::statement('DROP VIEW IF EXISTS product_lecture_sheets');
    }
}
